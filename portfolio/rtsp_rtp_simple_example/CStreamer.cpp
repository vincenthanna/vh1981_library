...
void CStreamer::SendRtpPacket(unsigned char * Jpeg, int JpegLen, int Chn)
{
...
#define KJpegHeaderSize 8           // size of the special JPEG payload header
    ...
    /**
     * RTP over RTSP의 경우 기존 RTP header앞에 4 바이트의 추가 헤더 정보가 붙는다.
     * 그냥 UDP 전송의 경우 추가 header 정보는 skip.
     */
