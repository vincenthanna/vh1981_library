...
def sample_01():
    ...
    #conv2d_img = np.swapaxes(conv2d_img, 0, 3) #안해도 동일한 결과
    print("np.swapaxes(conv2d_img, 0, 3).shape", conv2d_img.shape)  # (1, 2, 2, 1)
...
def sample_02():
    ...
    #weight shape [width, height, input_channel_count, output_channel_count]
